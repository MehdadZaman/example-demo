...
public class DailyLogPage2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daily_log_page2);
    ...
    public void setIntakePercentages()
    {
        ...
        dailyIntakes.add(2100L);
        dailyIntakes.add(250L);
        dailyIntakes.add(345L);
        dailyIntakes.add(100L);
        dailyIntakes.add(650L);
        ArrayList<Long> maxIntakes = new ArrayList<>();
        maxIntakes.add(2200L);
        maxIntakes.add(300L);
        maxIntakes.add(360L);
        maxIntakes.add(120L);
        maxIntakes.add(600L);
    ...
    public void createBarGraph(double calorie, double fat, double fiber, double sodium, double protein){
        ...
        barChart = (BarChart) findViewById(R.id.barChart2_02);
    ...
    public void showWarningMessage(ArrayList<Long> dailyIntakes, ArrayList<Long> maxIntakes){
        ...
        if(flag){
            ...
            TextView t = findViewById(R.id.warningDescription2_02);
            t.setText(s);
        }

        String s1 = "Consumed:\n"; //String.format("%25s %-20s %-10s\n","","Current","Limit");
        String s2 = "Maximum:\n"; //String.format("%25s %-20s %-10s\n","","Current","Limit");
        TextView t1 = findViewById(R.id.currentNumberIntakes2_02);
        TextView t2 = findViewById(R.id.dailyNumberIntakes2_02);
